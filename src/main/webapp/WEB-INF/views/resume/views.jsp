   ...
   <div class="main-container">
      ...
      <form action="/Resume/View" method="POST">
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-9">
               <input type="text" class="form-control" name="resume_career_startdate" value="${mapResumeCareer.resume_career_startdate}">
            </div>
         </div>
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-9">
               <input type="text" class="form-control" name="resume_career_enddate" value="${mapResumeCareer.resume_career_enddate}">
            </div>
         </div>
...
<script>
function goToList() {
   location.href = '/Resume/List?user_id=${resumeVo.user_id}';
}
</script>
