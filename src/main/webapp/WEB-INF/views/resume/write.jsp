...
<!--             <div class="col-sm-9"> -->
<%--                <input type="checkbox" class="form-check-input" name="user_stack_name"  value="${mapUserStack.user_stack_name}"> --%>
...
//     	userStackList.push(checkbox.value);
//     });
    
//     // hidden input에 선택된 스택을 설정
//     document.getElementById("userStackList").value = userStackList.join(',');
